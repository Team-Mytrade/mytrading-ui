...
// import BatchSerialManager from "./pages/Inventory/BatchSerialManager";
...
//import { NotificationProvider } from "./pages/Notification/NotificationManager";
//import DemoPage from "./pages/Notification/DemoPage";
    ...
    <AuthProvider>
      <Router>
        ...
        <Routes>
          ...
          {/* Standalone Auth (optional direct access) */}
          <Route path="/signin" element={<SignIn />} />
          <Route path="/signup" element={<SignUp />} />
          <Route path="/forgetpassword" element={<Forget />} />
          <Route path="/contactus" element={<Contact />} />
