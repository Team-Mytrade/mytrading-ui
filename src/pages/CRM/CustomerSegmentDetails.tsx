      ...
      <div className="max-w-7xl mx-auto px-6 pb-6 pt-0 space-y-6">
        <div className="mb-2 flex items-center justify-between pt-0">
          ...
          <nav className="max-w-full overflow-x-auto">
            <ol className="flex items-center gap-2 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-gray-400">
              ...
              <li className="text-cyan-600 dark:text-white/90">Segments</li>
            </ol>
          </nav>
        </div>
        ...
        <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-3 h-full">
            <AddButton onClick={openCreateSegment} label="Add Segment" className="!mb-0" />
            {/* Filter Toggle */}
            <button
        ...
        {/* Segment Modal */}
        {showFormModal && (
          <div key="segment-modal" className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm overflow-y-auto p-4">
        ...
        {showCustomerModal && (
          <div key="customer-modal" className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-4">
