                        ...
                        {availableMonths.map((item, idx) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full py-2.5 bg-white border border-gray-300 hover:bg-cyan-50 hover:text-cyan-700 hover:border-cyan-300 text-gray-700 text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
                                >
                                    Download PDF
                                </button>
                            </motion.div>
