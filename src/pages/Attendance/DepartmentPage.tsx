...
const DepartmentPage: React.FC = () => {
  ...
  const promptDelete = (dept: Department) => { setDeletingItem(dept); setShowDeletePopup(true); };
  ...
  const stats = {
    ...
    locations: new Set(departments.map(d => d.location).filter(Boolean)).size,
  };
  ...
  return (
    <>
      ...
      <DynamicPopup
        ...
        subText="Are you sure you want to delete this department? This action cannot be undone."
        confirmLabel="Delete"
        cancelLabel="Cancel"
