...
import { ReactComponent as LeadIcon } from "./lead.svg?react";
import { ReactComponent as ContactIcon } from "./contact.svg?react";
import { ReactComponent as AccountIcon } from "./account.svg?react";
import { ReactComponent as DealIcon } from "./deal.svg?react";
import { ReactComponent as TaskActivityIcon } from "./task.svg?react";
import { ReactComponent as SalesIcon } from "./sales.svg?react";
import { ReactComponent as MarketingIcon } from "./marketing.svg?react";
import { ReactComponent as SupportIcon } from "./support.svg?react";

import { ReactComponent as ReportIcon } from "./report.svg?react";
import { ReactComponent as WorkFlowIcon } from "./workflow1.svg?react";
...
import { ReactComponent as PurchaseIcon } from "./purchase.svg?react";
import { ReactComponent as DeliveryIcon } from "./delivery.svg?react";
import { ReactComponent as InvoiceIcon } from "./invoice.svg?react";
import { ReactComponent as PayrollIcon } from "./payroll.svg?react";
import { ReactComponent as AttendanceIcon } from "./attendance.svg?react";
