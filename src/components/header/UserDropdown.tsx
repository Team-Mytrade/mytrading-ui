...
export default function UserDropdown() {
  ...
  function toggleDropdown() {
    setIsOpen(!isOpen);
    setStatusOpen(false); // Close status dropdown when main dropdown opens/closes
  }
  ...
  function toggleStatusDropdown(e: React.MouseEvent) {
      ...
      >
        <div className="flex items-start gap-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="flex-1 min-w-0">
            <span className="block font-medium text-gray-900 text-theme-sm dark:text-white">
              {user?.fullName?.split(' ')[0] || "User"}
            </span>
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className={`text-theme-xs ${getStatusText(status)} font-medium`}>
        ...
        <div className="py-3 border-b border-gray-200 dark:border-gray-800 relative" ref={statusRef}>
          <span className="block px-3 text-theme-xs font-medium text-gray-500 dark:text-gray-400 mb-2">
            Settings
          </span>
          <ul className="flex flex-col">
            <li className="relative">
              <button
                ...
                className="flex items-center justify-between w-full px-3 py-2 text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
              >
                <span className="flex items-center gap-3">
                  <span className={`w-2 h-2 rounded-full ${getStatusIndicator(status).split(' ')[0]}`}></span>
                  Set your status
                </span>
                <svg 
                  width="16" 
                  ...
                  viewBox="0 0 16 16" 
                  fill="none" 
                  className={`text-gray-400 transition-transform duration-200 ${statusOpen ? 'rotate-90' : ''}`}
                >
                  <path 
                    d="M6 12L10 8L6 4" 
                    stroke="currentColor" 
                ...
                <div className="absolute left-0 right-0 mt-1 ml-3 mr-3 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                  <div className="py-2">
                    ...
                    >
                      ...
                      <span>Available</span>
                      {status === "online" && (
                        <svg className="ml-auto w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      ...
                      <span>Away</span>
                      {status === "away" && (
                        <svg className="ml-auto w-4 h-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                      )}
                    </button>
        ...
        <div className="py-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <ul className="flex flex-col">
              ...
              <DropdownItem
                ...
                tag="a"
                to="/profile"
                className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg text-theme-sm hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
              >
                <svg
